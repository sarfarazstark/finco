		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent hideClose className="sm:max-w-[400px] p-5">
				...
				<div className="flex flex-col gap-4">
					...
					<div className="flex items-center gap-3 p-2 bg-grey-50 rounded-xl border border-red-200">
						<button
							type="button"
							onClick={() => {
						...
						<div className="flex-1 flex items-center gap-1">
							<span className="text-2xl font-bold text-red-500 leading-none flex items-center h-8">
								{currencySymbol}
							</span>
							<input
								type="number"
